...
import pl.lodz.p.user.adapters.soap.dto.auth.*;
import pl.lodz.p.user.adapters.soap.security.JwtSoapService;
import pl.lodz.p.user.domain.exceptions.AuthException;
...
public class AuthEndpoint {
    ...
    private static final String NAMESPACE = "http://pl.lodz.p.user.adapters.soap.dto.auth/";
