package pl.lodz.p.user.adapters.soap.config;
...
public class WebServiceConfig {
    ...
    public DefaultWsdl11Definition usersWsdl(XsdSchema userSchema) {
        ...
        def.setTargetNamespace("http://pl.lodz.p.user.adapters.soap.dto.user/");
    ...
    public DefaultWsdl11Definition authWsdl(XsdSchema authSchema) {
        ...
        def.setLocationUri("/ws");
        def.setTargetNamespace("http://pl.lodz.p.user.adapters.soap.dto.auth/");
