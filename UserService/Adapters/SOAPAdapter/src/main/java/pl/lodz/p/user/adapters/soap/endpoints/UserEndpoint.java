...
import pl.lodz.p.user.adapters.soap.dto.user.requests.*;
import pl.lodz.p.user.adapters.soap.dto.user.responses.*;
...
public class UserEndpoint {
    ...
    private static final String namespace = "http://pl.lodz.p.user.adapters.soap.dto.user/";
