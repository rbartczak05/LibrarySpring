    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                <input type="text" placeholder="Login" onChange={e => setFormData({...formData, login: e.target.value})} required />
                ...
                <input type="number" placeholder="Wiek" onChange={e => setFormData({...formData, age: e.target.value})} required />
                <div>
